...
<body class="hold-transition sidebar-mini">
	...
	<div class="wrapper">
		...
		<nav class="main-header navbar navbar-expand navbar-default navbar-light">
			...
			<ul class="navbar-nav">
				...
				<li class="nav-item d-none d-sm-inline-block">
					<a href="?page=rekap_km" class="nav-link">Rekap Kas Mushola</a>
				</li>
				<li class="nav-item d-none d-sm-inline-block">
		...
		<aside class="main-sidebar sidebar-dark-primary elevation-4">
			...
			<a href="http://localhost/kas_masjid/" class="brand-link">
				...
				<span class="brand-text font-weight-light"> Mushola Al Qadir</span>
			</a>
    ...
    ?>
		...
		<footer class="main-footer">
			...
			Copyright &copy;
			<a target="_blank" href="https://web.facebook.com/rizky.kik">
				<strong> Mushola Al Qadir</strong>
			</a>
			All rights reserved 2022 By Rizky.Kik.
		</footer>
